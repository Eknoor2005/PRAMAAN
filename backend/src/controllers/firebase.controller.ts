...
export class FirebaseController {
  static async firebaseSignup(req: AuthenticatedRequest, res: Response) {
    try {
      const { firebaseUid, email, firstName, lastName, authMethod } = req.body;

      if (!firebaseUid || !email || !authMethod) {
  ...
  static async firebaseSocialAuth(req: AuthenticatedRequest, res: Response) {
    try {
      const { firebaseUid, email, firstName, lastName, authMethod, photoURL } = req.body;
